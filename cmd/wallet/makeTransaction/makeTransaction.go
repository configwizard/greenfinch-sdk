...
const NEOFS_TESTNET_CONTRACT_SCRIPT_HASH = "0x3c3f4b84773ef0141576e48c3ff60e5078235891" //todo is this still the correct contract
const usage = `Example
...
var (
	...
	contractScriptHash = flag.String("hash", NEOFS_TESTNET_CONTRACT_SCRIPT_HASH, "defaults to testnet")
)
...
func main() {
	...
	transactionID, transaction, err := wallet.CreateTransactionFromFunctionCall(*contractScriptHash, operation, network, acc, params)
	if err != nil {
